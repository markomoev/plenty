...
const categories: PostCategory[] = ["Стилови Насоки", "За Магазина", "Съвети"];
          ...
          >
            ...
            <div>
              <div className="flex items-center gap-4 mb-6">
                <span
                  className={`text-[10px] font-black uppercase tracking-[0.2em] ${categoryColors[featured.category]}`}
                >
                  {featured.category}
                </span>
              ...
              <p className="text-secondary text-sm leading-relaxed mb-8">{featured.excerpt}</p>
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex items-center gap-4 mb-4">
                    <span
                      className={`text-[10px] font-black uppercase tracking-[0.2em] ${categoryColors[post.category]}`}
                    >
                      {post.category}
                    </span>
                    <span className="text-[10px] uppercase tracking-widest text-secondary">
